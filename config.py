...
LLAMA_CPP_PORT = 8080
LLAMA_CPP_SERVER_EXE_PATH = BASE_DIR / "llama" / "llama-server.exe"
LLAMA_CPP_MODELS_DIR = BASE_DIR / "models"
LLAMA_CPP_DEFAULT_MODEL = "gemma3.gguf"
...
LLAMA_CPP_CHAT_COMPLETIONS_URL = (
    f"http://{LLAMA_CPP_HOST}:{LLAMA_CPP_PORT}/v1/chat/completions"
)
...
LLAMA_CPP_REQUEST_TIMEOUT_SEC = 30
